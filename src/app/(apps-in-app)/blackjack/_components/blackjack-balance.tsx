...
export const BlackjackBalance = (): ReactElement => {
  ...
  return (
    <div className="flex items-center gap-2 bg-white bg-opacity-10 p-3 rounded-md">
      <h1 className="text-lg">
        {lang === "fr" ? "Solde" : "Balance"}: {balance}{lang === "fr" ? "€" : "$"}
      </h1>

      <button
        className="bg-white bg-opacity-10 text-white rounded-md px-3 py-1 group"
  ...
  return (
    <div className="flex items-center justify-center h-screen w-screen bg-green-900 relative">
      <div className="flex flex-col items-center gap-5 p-3">
        <div className="bg-white bg-opacity-10 p-5 rounded-md text-white">
